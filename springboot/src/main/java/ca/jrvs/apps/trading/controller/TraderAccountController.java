...
public class TraderAccountController {
  ...
  @ApiOperation(value = "Create a trader and an account.",
    notes = "TraderId and AccountId are auto generated by database, and"
        + "they should be identical. Assume each trader has exact one account.")
  @ResponseStatus(HttpStatus.CREATED)
  @ResponseBody
  @PutMapping(
      path = "/firstname/{firstName}/lastname/{lastName}/dob/{dob}/country/{country}"
          + "/email/{email}", produces = {MediaType.APPLICATION_JSON_UTF8_VALUE})
  ...
  @ApiOperation(value = "Delete a trader.",
      notes = "Delete a trader if its account amount is 0 and has no open positions"
